      ...
      <div className="max-w-[1200px] mx-auto flex justify-between items-center sm:px-8 xs:px-4 sm:py-3 xs:py-1">
        ...
        <div className="md:hidden">
          <Sheet>
            ...
            <SheetContent
              side="right"
              className="bg-gray-900 text-white border-l border-gray-700 w-[80vw] sm:w-[250px]"
            >
              <nav className="flex flex-col gap-4 mt-12 text-base sm:text-lg xs:px-3 sm:px-6">
                {/* About Section */}
                ...
                <Link
                  href="#contact"
                  className="font-semibold bg-white text-black xs:px-2 xs:py-1 sm:px-3 sm:py-1 rounded-md w-fit text-sm sm:text-base"
                >
                  Contact
                </Link>
              </nav>
